...
export function Sidebar({ open, onClose }: Props) {
  const { activeAccount, accounts, setActiveAccount } = useAuth()
    ...
    <>
      ...
      `}>
        ...
        <div className="p-3 border-t border-dark-200">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-dark-200 cursor-pointer transition-colors">
